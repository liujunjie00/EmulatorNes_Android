...
public class DashboardView4 extends View {
    ...
    public int getmLength1() {
        return mLength1;
    }

    public void setmLength1(int mLength1) {
        this.mLength1 = mLength1;
    }

    public int getmLength2() {
        return mLength2;
    }

    public void setmLength2(int mLength2) {
        this.mLength2 = mLength2;
    }

    public int getmPLRadius() {
        return mPLRadius;
    }

    public void setmPLRadius(int mPLRadius) {
        this.mPLRadius = mPLRadius;
    }

    public int getmPSRadius() {
        return mPSRadius;
    }

    public void setmPSRadius(int mPSRadius) {
        this.mPSRadius = mPSRadius;
    }
    ...
    public RectF getmRectFArc() {
        return mRectFArc;
    }

    public void setmRectFArc(RectF mRectFArc) {
        this.mRectFArc = mRectFArc;
    }

    public RectF getmRectFInnerArc() {
        return mRectFInnerArc;
    }

    public void setmRectFInnerArc(RectF mRectFInnerArc) {
        this.mRectFInnerArc = mRectFInnerArc;
    }

    public Rect getmRectText() {
        return mRectText;
    }

    public void setmRectText(Rect mRectText) {
        this.mRectText = mRectText;
    }
